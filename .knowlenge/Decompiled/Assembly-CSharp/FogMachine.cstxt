...
public class FogMachine : ContainerIOEntity
{
	...
	public void CheckTrigger()
	{
		...
		{
			if (entityContent is BasePlayer basePlayer && !basePlayer.IsSleeping() && basePlayer.IsAlive() && !basePlayer.IsBuildingAuthed() && basePlayer.CanSee(basePlayer.eyes.position, targetPos))
			{
				StartFogging();
				break;
			}
