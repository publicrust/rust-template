...
public class ReclaimTerminal : StorageContainer
{
	...
	public void LoadReclaimLoot(BasePlayer player)
	{
		...
		List<ReclaimManager.PlayerReclaimEntry> list = Facepunch.Pool.Get<List<ReclaimManager.PlayerReclaimEntry>>();
		...
		Facepunch.Pool.Free(ref list, freeElements: false);
		SendNetworkUpdate();
	}
	...
	public override void PlayerStoppedLooting(BasePlayer player)
	{
		if (!(ReclaimManager.instance == null))
		{
			...
			if (base.inventory.itemList.Count > 0)
			{
				...
				player.ShowToast(GameTip.Styles.Blue_Long, DespawnToast, false);
			}
