...
public class GameModeSoftcore : GameModeVanilla
{
	...
	public void ReturnItemsTo(ref List<Item> source, ItemContainer itemContainer)
	{
		...
		Facepunch.Pool.Free(ref source, freeElements: false);
	}

	public override void OnPlayerDeath(BasePlayer instigator, BasePlayer victim, HitInfo deathInfo = null)
	{
		if (victim != null && (victim.IsInTutorial || (victim.net != null && victim.net.group != null && victim.net.group.restricted)))
		{
			return;
		}
		if (victim != null && !victim.IsNpc && !victim.IsInTutorial)
		{
			...
			List<Item> to = Facepunch.Pool.Get<List<Item>>();
			...
			if (to.Count > 0)
			{
				newID = ReclaimManager.instance.AddPlayerReclaim(victim.userID, to, (instigator == null) ? ((BasePlayer.EncryptedValue<ulong>)0uL) : instigator.userID, (instigator == null) ? "" : instigator.displayName);
			}
			...
			Facepunch.Pool.Free(ref to, freeElements: false);
		}
